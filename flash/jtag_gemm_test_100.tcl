# On-board 16x16 NPU GEMM test @ 100 MHz, via ctrl_axi (PS-AXI 0x4000_0000).
# Same 2x2 driver as the 30MHz test (the pipelined readback is transparent to SW).
...
puts "### 16x16 bitstream @100 MHz (FCLK0=0x00100A00) ready; driving RV32 via ctrl_axi ###"
...
if {$c00==39 && $c01==53 && $c10==17 && $c11==23} {
    puts ">>> BOARD-GEMM-100MHZ: PASS  (16x16 NPU on real XC7Z020 @ 100 MHz matches golden) <<<"
} else {
