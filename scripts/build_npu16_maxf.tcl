...
catch { open_run impl_1 ; report_timing_summary -max_paths 15 -file C:/work/github/RV32-FullStack/flash/timing_maxf.rpt }
set bit [glob -nocomplain C:/work/github/RV32-FullStack/vivado_zynq/rv32_zynq.runs/impl_1/*.bit]
if {$bit ne ""} { file copy -force [lindex $bit 0] C:/work/github/RV32-FullStack/flash/rv32_16x16_maxf.bit }
