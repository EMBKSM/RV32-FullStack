...
#   source C:/work/github/RV32-FullStack/scripts/build_npu16_106closed.tcl
# or batch:
#   vivado -mode batch -source C:/work/github/RV32-FullStack/scripts/build_npu16_106closed.tcl
...
catch { source C:/work/github/RV32-FullStack/scripts/package_platform_ip.tcl }
...
puts "### 106-CLOSE status=$st   WNS=$wns   TNS=$tns ###"
    ...
    open_run impl_1
    report_timing_summary -max_paths 10 -file C:/work/github/RV32-FullStack/flash/timing_106closed.rpt
    report_utilization              -file C:/work/github/RV32-FullStack/flash/util_106closed.rpt
}
set bit [glob -nocomplain C:/work/github/RV32-FullStack/vivado_zynq/rv32_zynq.runs/impl_1/*.bit]
if {$bit ne ""} { file copy -force [lindex $bit 0] C:/work/github/RV32-FullStack/flash/rv32_16x16_106closed.bit }
