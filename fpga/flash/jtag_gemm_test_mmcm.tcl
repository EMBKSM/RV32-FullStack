# On-board 16x16 NPU GEMM test @ 106 MHz via a PL MMCM (FCLK0=100 -> MMCM -> 106),
# driven over ctrl_axi (PS-AXI 0x4000_0000). FCLK0 stays 100MHz (the MMCM input);
# the bitstream's MMCM generates the 106MHz PL clock. A=[[3,4],[1,2]] B=[[5,7],[6,8]].
connect
...
fpga -f C:/work/github/RV32-FullStack/fpga/flash/rv32_16x16_mmcm.bit
ps7_post_config
memmap -addr 0x40000000 -size 0x00010000 -flags 3
puts "### 16x16 + PL MMCM: FCLK0=100MHz -> MMCM -> 106MHz PL; driving RV32 via ctrl_axi ###"
...
puts "BOARD  16x16 NPU GEMM @106MHz(MMCM):  C00=$c00  C01=$c01  C10=$c10  C11=$c11"
puts "GOLDEN                             :  C00=39   C01=53   C10=17   C11=23"
if {$c00==39 && $c01==53 && $c10==17 && $c11==23} {
    puts ">>> BOARD-GEMM-MMCM-106MHZ: PASS  (16x16 NPU @ 106 MHz via PL MMCM on real XC7Z020 matches golden) <<<"
} else {
    puts ">>> BOARD-GEMM-MMCM-106MHZ: MISMATCH <<<"
}
disconnect
puts "GEMM-TEST-MMCM-COMPLETE"
