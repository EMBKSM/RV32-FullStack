...
set wns [_wns]
puts "WNS_FINAL = $wns"
report_timing_summary -max_paths 5 -file C:/work/github/RV32-FullStack/fpga/flash/timing_mmcm_opt.rpt
if {$wns >= 0.0} {
  write_bitstream -force C:/work/github/RV32-FullStack/fpga/flash/rv32_16x16_mmcm_tc.bit
